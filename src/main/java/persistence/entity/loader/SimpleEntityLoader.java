...
public class SimpleEntityLoader implements EntityLoader {
    private final Logger log = LoggerFactory.getLogger(SimpleEntityLoader.class);
    private final JdbcTemplate jdbcTemplate;
    private final QueryGenerator queryGenerator;
    private final EntityMapper entityMapper;

    public SimpleEntityLoader(JdbcTemplate jdbcTemplate, QueryGenerator queryGenerator, EntityMapper entityMapper) {

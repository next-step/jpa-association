...
class DefaultPagingStrategyTest {
    ...
    void defaultPagingStrategyOffsetZeroTest() {
        final String query = pagingStrategy.renderPagingQuery(PageQuery.of("select id, age, email from user", 0, 10));
    ...
    void defaultPagingStrategyWithOffsetTest() {
        final String query = pagingStrategy.renderPagingQuery(PageQuery.of("select id, age, email from user", 1, 10));

    ...
    class loadCollection {
        ...
        public class withValidArgs {
            ...
            void returnListObject() {
                ...
                EntityPersister entityPersister = new SimpleEntityPersister(jdbcTemplate, entityLoader);
                ...
                List<EntityFixtures.OrderItem> orderItems = collectionLoader.loadCollection(EntityFixtures.OrderItem.class, "order_id", "1");

                assertThat(orderItems.toString()).isEqualTo("[OrderItem{id=1, product='티비', quantity=1, orderId=1}, OrderItem{id=2, product='세탁기', quantity=3, orderId=1}]");
            }
        }
    }
}
